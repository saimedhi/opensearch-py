...
class SecurityClient(NamespacedClient):
    ...
    @query_params()
    def get_audit_config(self, params=None, headers=None):
        """
    ...
    @query_params()
    def get_roles_mapping(self, params=None, headers=None):
        """
    ...
    @query_params()
    def patch_audit_config(self, body, params=None, headers=None):
        """
    ...
    @query_params()
    def patch_roles_mappings(self, body, params=None, headers=None):
        """
