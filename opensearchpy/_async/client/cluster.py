...
class ClusterClient(NamespacedClient):
    ...
    async def health(self, index=None, params=None, headers=None):
        ...
        :arg ensure_node_commissioned: Checks whether local node is
            commissioned or not. If set to true on a local call it will throw
            exception if node is decommissioned.
