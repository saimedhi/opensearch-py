    ...
    def test_knn_model(self) -> None:
        ...
        self.client.indices.create(
            ...
            body={
                ...
                "mappings": {
                    "properties": {
                        "train-field": {"type": "knn_vector", "dimension": 4}
                    }
                },
            },
        )
        ...
        # Train model
        response = self.client.plugins.knn.train_model(
            model_id="my-model",
            body={
        ...
        print("knn train_model response", response)
        ...
        print("knn get_model response", response)
